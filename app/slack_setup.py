...
def register_slack_handlers(app: AsyncApp) -> None:
        ...
        try:
            ...
            await client.views_open(
                ...
                view={
                    ...
                    "title": {"type": "plain_text", "text": f"Update Status"},
    ...
    async def handle_global_update_status_submission(ack, body, view, client):
        ...
        try:
            ...
            if entity_type == "mission":
                from features.missions.domain import MissionStatus
                from infrastructure.slack_blocks.mission_blocks import build_mission_detail_blocks
                ...
                from features.operations.domain import OperationStatus
                from infrastructure.slack_blocks.operation_blocks import build_operation_detail_blocks
                ...
                from features.workflows.domain import WorkflowStatus
                from infrastructure.slack_blocks.workflow_blocks import build_workflow_detail_blocks
